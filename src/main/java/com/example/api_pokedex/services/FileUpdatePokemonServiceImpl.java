...
@Service
public class FileUpdatePokemonServiceImpl implements IFileUpdatePokemonService {
    @Autowired
    ...
    public String upload(MultipartFile multipartFile, Long idPokemon) {
        String fileUrl = "";
        ...
        updateTrainerImage(fileUrl,idPokemon);

        return fileUrl;
    }

    private void updateTrainerImage(String ImageUrl,Long idPokemon){
        Pokemon pokemon = pokemonService.FindOneAndEnsurePicture(idPokemon);
